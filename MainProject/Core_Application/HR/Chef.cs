...
namespace Cafe_Program.HR
{
    internal class Chef: Employee
    {
        ...
        public Chef(string firstName, string lastName, string email, double rate, DateOnly birthDate, DateOnly hireDate, string address1, string zipcode, string city) : base(firstName, lastName, email, rate, birthDate, hireDate, address1, zipcode, city)
        {
